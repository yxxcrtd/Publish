...
<% 
  ...
  vars.put("this", vars.get("channel"));

  /*
    vars.put("column", ((com.chinaedustar.publish.model.Channel) vars.get("this")).getColumnTree());
  ...
  */
  ...
  String templ_content = test.Util.readFileContent(
		  application.getRealPath("/news/index_template.html"));
