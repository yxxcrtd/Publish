...
out.println("    window.showModalDialog(\"editor_previewContent.asp?Content=\"+Content+\"&ChannelID=" + channelId + ",toolbar=no, menubar=no, top=0,left=0,dialogwidth=800,dialogheight=600,help: no; scroll:yes; status: yes\");");
out.println(" }");
out.println("</script>");
...
out.println("</head>");
out.println("<body>");
out.println("<form action='editor_CustomListLabel.asp' method='post' name='myform' id='myform'>");
