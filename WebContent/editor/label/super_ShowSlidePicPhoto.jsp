<%@ page language="java" contentType="text/html; charset=gb2312"
	pageEncoding="UTF-8"%>
<%@page import="com.chinaedustar.publish.model.Site"%>
...
function change_item(element){
	...
	#{call label_main_temp("ShowSlidePicPhoto","显示幻灯片图片标签") }
</pub:template>
...
<form action='super_ShowSlidePicPhoto.jsp' method='post' name='myform' id='myform'>
		<tr class='tdbg'>
