...
function change_item(element){
    ...
    if(selectednumber==1){
        objFiles.style.display="";
            ...
            $("common").src = "<%=installDir %>soft/images/Soft_common.gif"
            $("elite").src = "<%=installDir %>soft/images/Soft_elite.gif"
            $("ontop").src = "<%=installDir %>soft/images/Soft_ontop.gif"
    ...
    else if (selectednumber>=3)
    {
        ...
        objFiles.style.display="";
            ...
            $("common").src = "<%=installDir %>soft/images/Soft_common" + selectednumber + ".gif"
            $("elite").src = "<%=installDir %>soft/images/Soft_elite" + selectednumber + ".gif"
            $("ontop").src = "<%=installDir %>soft/images/Soft_ontop" + selectednumber + ".gif"
        
    }
}
</script>
	#{call label_main_temp("ShowSlidePicSoft","幻灯片下载函数标签") }
</pub:template>
...
<form action='super_ShowSlidePicSoft.jsp' method='post' name='myform' id='myform'>
		<tr class='tdbg'>
			<td height='25' align='right' class='tdbg5'><strong>所属频道：</strong></td>
			<td height='25'>
			<select idd='channelId' name='channelId' onChange='document.myform.submit();'>
		...
		<tr class='tdbg'>
			...
			<input type='checkbox' name='includeChild' value='1'>包含子栏目&nbsp;&nbsp;<br>
	...
	<tr class='tdbg'>
		...
		<td height='25'><input id='Num' name='Num' type='text' value=4 size='5'
			maxlength='3'> <font color='#FF0000'>如果为0，将显示所有软件。</font></td>
	</tr>
	<tr class='tdbg'>
		<td height='25' align='right' class='tdbg5'><strong>软件属性：</strong></td>
		<td height='25'><input name='IsHot' type='checkbox' id='IsHot'
			value='0'> 热门软件&nbsp;&nbsp;&nbsp;&nbsp; <input
			name='IsElite' type='checkbox' id='IsElite' value='0'> 推荐软件
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color='#FF0000'>如果都不选，将显示所有软件</font></td>
	</tr>
	<tr class='tdbg'>
		...
		天内更新的软件&nbsp;&nbsp;&nbsp;&nbsp;<font color='#FF0000'>&nbsp;&nbsp;如果为空或0，则显示所有天数的软件</font></td>
	</tr>
	<tr class='tdbg'>
		<td height='25' align='right' class='tdbg5'><strong>排序方法：</strong></td>
		<td height='25'><select name='OrderType' id='OrderType'>
			<option value='1'>软件ID（降序）</option>
			<option value='2'>软件ID（升序）</option>
