...
<title>登陆</title>
<link type="text/css" rel="stylesheet" href="../Skin/Tsinghua/default.css"/>
<style type="text/css"> 
html,body 
{ 
...
<div style="text-align:right;padding-top:93px;padding-right:20px">
<!--登陆框-->
<%
...
%>
  <a id="aaa" href="<%= loginUrl%>" target="_parent"><font color="#ffffff">登 录</font></a> 
  <script>
  	var surl="<%=loginUrl%>";
...
<%}
	...
	out.print("&nbsp;&nbsp;|&nbsp;&nbsp;<a href='http://ae.ee.tsinghua.edu.cn/groups/"+userLoginName+"' + userLoginName target='_blank'><font color=red>个人空间</font></a>");
