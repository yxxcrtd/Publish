...
<div style="text-align:right;padding-top:43px;padding-right:4px">
<!--登陆框-->
<%
...
%>
  <a id="aaa" class="" href="<%= loginUrl%>" target="_parent"><font class="login">登 录</font></a> 
  <script>
  	var surl="<%=loginUrl%>";
...
else
{
	...
	out.print("&nbsp;|&nbsp;进入<a href='http://ae.ee.tsinghua.edu.cn/groups/"+userLoginName+"' target='_blank'><font color=red>个人空间</font></a>");
