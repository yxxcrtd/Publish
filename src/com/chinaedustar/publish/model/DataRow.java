...
public class DataRow extends java.util.ArrayList<Object> {
	...
	/**
	 * 得到指定列的值。
	 * @param columnIndex - 列索引，从 0 开始算起。
	 * @return 值。
	 */
	@Override public Object get(int columnIndex) {
		...
		/*
			throw new IndexOutOfBoundsException("columnIndex == " + columnIndex + 
					" out of bound " + table.getSchema().size());
			*/
	}
	 ...
	 * @param value 值。
	 */
	@Override public Object set(int columnIndex, Object value) {
		DataSchema schema = table.getSchema();
